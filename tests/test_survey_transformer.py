...
class TestSurveyTransformer(unittest.TestCase):
    ...
    def transform_pck(self, test_scenarios, output_extension):
        ...
        for scenario_filename in test_scenarios:
            ...
            transformer = get_transformer(SurveyResponseV1(payload))
    ...
    def test_create_index(self):
        ...
        for scenario_filename in test_scenarios:
            ...
            transformer = get_transformer(SurveyResponseV1(payload_object), 1000)
            ...
            filename = "EDC_QImages/Index/EDC_{}_{}_{}.csv".format(
